...
Spinner primaryHeatSpinner;
    public static final String NATURAL = "com.example.homeenergy.NATURAL";
    public static final String ELECTRICITY = "com.example.homeenergy.ELECTRICITY";
    public static final String FUELOIL = "com.example.homeenergy.FUELOIL";
    public static final String PROPANE = "com.example.homeenergy.PROPANE";
